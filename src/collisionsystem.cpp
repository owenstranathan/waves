...
void EnterVisitor::visit(Platform *platform, Collidable *c)
{
	c->collisionEnter(platform);
}
...
void StayVisitor::visit(Platform *platform, Collidable *c)
{
	c->collisionStay(platform);
}
...
void ExitVisitor::visit(Platform *platform, Collidable *c)
{
	c->collisionExit(platform);
}
